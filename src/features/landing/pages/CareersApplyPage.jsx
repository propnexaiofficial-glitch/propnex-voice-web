            ...
            <div className="max-h-[60vh] overflow-y-auto pr-2 custom-scrollbar text-white/70 text-sm space-y-4">
              {modalType === 'terms' ? (
                <>
                  ...
                  <p>Applying to a role does not guarantee an interview or an offer of employment. Jinnicore retains the sole discretion to determine candidates who best meet the needs of the position.</p>
                </>
              ) : (
                <>
                  <p>Your privacy and data security are our top priorities.</p>
                  <p><strong>1. Data Collection:</strong> We collect personal data such as your name, contact details, resume, and employment history for the sole purpose of evaluating your candidacy for open roles at Jinnicore.</p>
