...
const docs = [
  ...
  },
  {
    ...
    accent: 'from-emerald-500/40 via-black/55 to-black/90',
    border: 'border-emerald-400/25',
    glow: 'shadow-[0_0_32px_rgba(16,185,129,0.1)]',
    body: [
      'Handle Tier-1 support inquiries automatically 24/7 via voice agents.',
      'Instantly answer FAQs, check order status, or verify account details.',
      'Seamlessly transfer complex issues to human agents with full context.',
      'Reduce wait times and improve overall customer satisfaction scores.',
    ],
  },
  {
    id: 'industries',
