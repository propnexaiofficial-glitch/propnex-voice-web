    ...
    <SheetPortal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          side === "left" &&
            "inset-y-0 left-0 h-full w-[min(18rem,85vw)] border-r border-border data-[state=closed]:slide-out-to-left data-[state=open]:slide-in-from-left",
          side === "right" &&
            "inset-y-0 right-0 h-full w-[min(18rem,85vw)] border-l border-border data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right",
          className
        )}
        {...props}
      >
